...
namespace ProjectManager.Model
{
    public class ProjectNumber
    {
        ...
        public int SubElem { get; set; }
        public string Appn { get; set; }
        public int AppnNo { get; set; }
        ...
        public ProjectNumber(string _MIPRnum, string _Projnum, string _BillingElem, int _Network, int _Activity, int _SubElem, string _Appn, int _AppnNo, string _DocType, string _Program, string _Project, 
